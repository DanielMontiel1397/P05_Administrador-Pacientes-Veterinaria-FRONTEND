...
const AuthProvider = ({children} : AuthProviderProps) => {
    ...
    useEffect(() => {
        const autenticarUsuario = async () => {
            ...
            try{
                ...
                const {data : {data}} = await clienteAxios.get('/veterinarios/perfil', config);
    ...
    const actualizarPerfil = async (perfil : PerfilVeterinario): Promise<{ msg: string, error: boolean }> => {
        ...
        try{
            ...
            const {data : {data}} = await clienteAxios.put(url,perfil,config);
            setAuth(data)
            return {
    ...
    const cambiarPassword = async ( password : VeterinarioCambiarPassword): Promise<{msg: string; error: boolean;}> => {
        ...
        try{
             ...
             const {data : {data}} = await clienteAxios.put(url, password, config);
